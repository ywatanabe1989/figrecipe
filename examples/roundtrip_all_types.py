...
PLOT_TESTS = {
    'plot': {
        'args': lambda: (np.linspace(0, 10, 50), np.sin(np.linspace(0, 10, 50))),
...
def run_roundtrip_test(plot_type: str, test_config: dict, output_dir: Path) -> dict:
    ...
    try:
        ...
        create_comparison_figure(original_path, reproduced_path, comparison_path, plot_type)
