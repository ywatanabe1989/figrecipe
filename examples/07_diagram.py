...
# Diagram is internal API - import from _diagram module
...
def example_programmatic(output_dir, logger):
    ...
    d = Diagram(type="pipeline", title="Data Processing Pipeline")
...
def example_scientific(output_dir, logger):
    ...
    d = Diagram(type="workflow", title="Experiment Workflow")
...
def example_decision_tree(output_dir, logger):
    ...
    d = Diagram(type="decision", title="Model Selection")
