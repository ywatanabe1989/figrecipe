...
Outputs:
    ./09_diagram_out/diagram_lr.{png,yaml}
    ./09_diagram_out/diagram_tb.{png,yaml}
    ./09_diagram_out/roundtrip.{png,yaml}
    ./09_diagram_out/reproduced.{png,yaml}
"""
...
def main(
    ...
    s = fr.Diagram(title="EEG Analysis Pipeline", width_mm=350, height_mm=100)
    ...
    s2 = fr.Diagram(title="Neural Network", width_mm=150, height_mm=250)
    ...
    data = s.to_dict()
    s_loaded = fr.Diagram.from_dict(data)
    fig3, ax3 = fr.subplots()
    ax3.diagram(s_loaded, id="roundtrip")
    ...
    s4 = fr.Diagram(title="Simple Flow")
