...
class TestDiagramRender:
    ...
    def test_render_with_mermaid_ink(self):
        ...
        from figrecipe._diagram._render import render_diagram
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = render_diagram(d, output_path, backend="mermaid.ink")
    ...
    def test_render_svg_format(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = render_diagram(d, output_path, format="svg", backend="mermaid.ink")
